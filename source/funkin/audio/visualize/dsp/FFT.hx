...
// Fast/Finite Fourier Transforms (FFT)
class FFT {
  /**
  ...
  **/
  ...
  static function main() {
    ...
    final freqs = [5919.911, 12000.0, 15000.0, 18000.0, 20000.0]; // Added more frequencies
    ...
    final fs_fft = new OffsetArray([for (k in 1...halfN) fs_pos[k].conj()].concat(fs_pos), -(halfN - 1));
